...
def generate_confusion_matrix_from_annotations(gold_dir, system_dir, output_prefix="confusion_matrix", partition="dev", cleaned=False):
    """
    Genera matriz de confusión del modelo Llama3.1 sobre la partición de desarrollo del dataset SPG.
    ...
    # Título específico para Llama3.1 SPG con partición dinámica
...
def main():
    parser = argparse.ArgumentParser(description="Genera matriz de confusión NER del modelo Llama3.1 sobre las particiones dev/test del dataset SPG con 28 etiquetas en orden fijo")
