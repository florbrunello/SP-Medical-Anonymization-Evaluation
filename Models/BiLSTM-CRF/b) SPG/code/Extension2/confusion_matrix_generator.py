...
sobre las particiones de desarrollo y test del dataset SPG
...
def generate_confusion_matrix_from_annotations(gold_dir, system_dir, output_prefix="confusion_matrix", partition="dev", cleaned=False):
    """
    Genera matriz de confusión del modelo BiLSTM-CRF sobre las particiones dev/test del dataset SPG.
...
def main():
    parser = argparse.ArgumentParser(description="Genera matriz de confusión NER del modelo BiLSTM-CRF sobre las particiones dev/test del dataset SPG con 28 etiquetas en orden fijo")
