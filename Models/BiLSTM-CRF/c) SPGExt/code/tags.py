...
class PHITag(AnnotatorTag):
    valid_TYPE = ["NOMBRE_SUJETO_ASISTENCIA", "NOMBRE_PERSONAL_SANITARIO", "PROFESION",
                  ...
                  "ID_EMPLEO_PERSONAL_SANITARIO", "OTRO_NUMERO_IDENTIF", "SEXO_SUJETO_ASISTENCIA", 
                  "FAMILIARES_SUJETO_ASISTENCIA", "OTROS_SUJETO_ASISTENCIA", 
                  "DIREC_PROT_INTERNET", "TOKEN"]
...
class IDTag(PHITag):
    valid_TYPE = ["ID_ASEGURAMIENTO", "ID_CONTACTO_ASISTENCIAL", "IDENTIF_VEHICULOS_NRSERIE_PLACAS", 
