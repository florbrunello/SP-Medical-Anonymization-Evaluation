...
python create_vocabs.py --trainpickle ../train_word_ner_startidx_dict.pickle \
                        ...
                        --embfile RUTA/AL/FICHERO_BIOMED.vec --vocabEmbFile vocab_embeddings.npz
...
Nota: `--embfile` puede ser cualquier embedding en formato fastText de texto
(por ejemplo, alguno de los .vec de "Biomedical Word Embeddings for Spanish").
Los modelos de ese repositorio tienen dimensión 300, igual que `wiki.es.vec`,
así que no es necesario cambiar el código del modelo, solo indicar la ruta al
nuevo fichero .vec y reconstruir `vocab_embeddings.npz`.
