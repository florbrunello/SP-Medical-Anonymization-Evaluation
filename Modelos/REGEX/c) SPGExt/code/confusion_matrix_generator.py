...
def generate_confusion_matrix_from_annotations(gold_dir, system_dir, output_prefix="confusion_matrix", partition="dev", cleaned=False):
    """
    Genera matriz de confusión del modelo REGEX sobre la partición de desarrollo del dataset SPGExt.
    ...
    # Título específico para REGEX SPGExt con partición dinámica
...
def main():
    parser = argparse.ArgumentParser(description="Genera matriz de confusión NER del modelo REGEX sobre las particiones dev/test del dataset SPGExt con 28 etiquetas en orden fijo")
